...
export default function AdminLayout({
  ...
  return (
    <div
      className="h-screen w-screen flex bg-[#F8FAFC] overflow-hidden"
      dir="rtl"
    >
      {/* Sidebar */}
      <aside
        className={cn(
          // 👈 أضفنا h-full لضمان الامتداد الكامل وثبتنا موقعه بـ sticky top-0 md:h-full
          "sticky top-0 right-0 z-40 w-64 h-full bg-white text-slate-600 flex flex-col transition-transform duration-300 border-l border-slate-100 shadow-sm shrink-0",
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "bg-primary/10 text-primary" // تمييز العنصر النشط بخلفية خفيفة ولون نص أخضر رسمي #005F13
