...
export const DEPARTMENTS: Department[] = [
  {
    ...
    emoji: "🥖",
    apologyAr:
      "نعتذر منك بشدة، فجودة تجربتك هي أولويتنا.. 🥖 نحن نؤمن أن كل ملاحظة هي فرصة للتطور. فضلاً، ساعدنا لنفهم ما حدث.",
    questions: [
      {
        id: "taste",
  ...
  },
  {
    ...
    emoji: "🧀",
    apologyAr:
      "هدفنا أن نصل لبيتك بأفضل جودة.. نعتذر منك. فضلاً، ساعدنا لنفهم ما حدث لتجنب تكراره.",
    questions: [
      {
        id: "quality",
  ...
  },
  {
    ...
    emoji: "🥦",
    apologyAr:
      "يؤسفنا جداً أن منتجاتنا لم تكن بمستوى توقعاتك اليوم. نحن نحرص على الفرز اليومي وملاحظتك ستجعلنا نراجع المعايير فوراً.",
    questions: [
      {
        id: "quality",
  ...
  },
  {
    ...
    emoji: "⭐",
    apologyAr:
      "نعتذر عن أي تقصير في خدمتنا. نعدك بالعمل على تحسين مهارات فريقنا لضمان رضاك في المرات القادمة.",
    questions: [
      {
        id: "welcome",
